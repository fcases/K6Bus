...
pub const DomainConfig = struct {
    ...
    binary_format: ?BinaryFormat = .BIN_PROTOBUF ,
    ...
    pub fn seriigiAlBin(self: *DomainConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, DomainConfig, @as(*DomainConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *DomainConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
...
pub const TransportConfig = struct {
    ...
    fn legiElProtobufTeksto(allocator: all.Allocator, it: *TokenIterType) !TransportConfig {
        ...
        while (it.next()) |tok| {
            ...
            if( equal(u8, tok, "mcast" ) ) { 
                const sub_msg = try MCastConfig.legiElProtobufTeksto(allocator, it); 
    ...
    pub fn seriigiAlBin(self: *TransportConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, TransportConfig, @as(*TransportConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *TransportConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
    ...
    fn deseriigi(allocator: all.Allocator, buffer: *DecodeBuffer, data_length: ?usize) !TransportConfig {
        ...
        while (buffer.read_index < end) {
            ...
            if ( field_number == 1 and wire_type == 2 ) 
                ...
                mia_Mesagho.mcast = try MCastConfig.deseriigi(allocator, buffer, try buffer.decodeVarint() );
        }
...
pub const MCastConfig = struct {
    ...
    pub fn seriigiAlBin(self: *MCastConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, MCastConfig, @as(*MCastConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *MCastConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
...
pub const BCastConfig = struct {
    ...
    pub fn seriigiAlBin(self: *BCastConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, BCastConfig, @as(*BCastConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *BCastConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
...
pub const UDPStarConfig = struct {
    ...
    pub fn seriigiAlBin(self: *UDPStarConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, UDPStarConfig, @as(*UDPStarConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *UDPStarConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
...
pub const EndPointConfig = struct {
    ...
    pub fn seriigiAlBin(self: *EndPointConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, EndPointConfig, @as(*EndPointConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *EndPointConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
...
pub const UnixSocketStarConfig = struct {
    ...
    pub fn seriigiAlBin(self: *UnixSocketStarConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, UnixSocketStarConfig, @as(*UnixSocketStarConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *UnixSocketStarConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
...
pub const CrossConnectorConfig = struct {
    ...
    pub fn seriigiAlBin(self: *CrossConnectorConfig, allocator: all.Allocator, b_formato: BinaraFormato) ![]const u8 {
        return try seriigiTiponAlBin(allocator, CrossConnectorConfig, @as(*CrossConnectorConfig,self), b_formato);
    }

    pub fn seriigiAlDosiero(self: *CrossConnectorConfig, allocator: all.Allocator, path: []const u8, b_formato: BinaraFormato) !void {
